...
const FoodCard: React.FC<{ entry: FoodEntry }> = ({ entry }) => {
  return (
    <>
      <li className="p-2 bg-gray-100 rounded-xl flex justify-center items-center">
        <div className="py-2">
          <div className="font-semibold">
            {entry.name} | {entry.calories} kcal
          </div>
          <div className="text-gray-600 flex flex-row justify-between font-medium tracking-wide">
